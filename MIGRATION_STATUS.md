...
| 上传与校验 | 研究包已完成首轮 | 13 个研究包均已上传，且以 rclone checksum 一致性检查通过；Codex 私有冷备待最终一致性/加密步骤 |
...
当前已经制备并验证的研究包为 **1,629,920,623 B（1.518 GiB）**。这是经过逐项筛选、压缩且带 SHA-256 的 13 个包，而不是先前的粗略上界。
